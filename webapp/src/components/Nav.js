...
const Nav = () => {
  ...
  return (
    <AppBar
      position="static"
      sx={{ backgroundColor: "purple", padding: "5px" }}
    >
      <Toolbar
        sx={{
          display: "flex",
      ...
      >
        ...
        <Box sx={{ display: "flex", gap: 1, marginLeft: "auto" }}>
          <Button
            color="inherit"
            onClick={() => navigate("/auth", { state: { loginView: true } })}
          >
          ...
          <Button
            ...
            onClick={() => navigate("/auth", { state: { loginView: false } })}
          >
