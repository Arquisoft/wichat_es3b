...
The deployment url is: [https://arquisoft.github.io/wichat_en3b/](https://arquisoft.github.io/wichat_en3b/).
...
If we want to deploy it to GitHub pages, so it is accessible via [https://arquisoft.github.io/wichat_en3b/](https://arquisoft.github.io/wichat_en3b/), we need to execute `npm run deploy`.
